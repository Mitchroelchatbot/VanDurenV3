...
| F18 | **De voorgestelde hero-poster toont een andere hal. Niet geplaatst.** `hero-poster-voorlopig-1024.webp` (en de `.jpg`) tonen een hal met het spandoek **"LA VIDA PADEL"**, een donker plat dak, een entresol links en een rode omloop. De hal van Van Duren heeft een licht gebogen dak met open spanten, een blauwe achterwand en het bord "PADEL ACADEMY VAN DUREN powered by Babolat". Zie `docs/bewijs-hero-verkeerde-hal.jpg`, linkerkolom Van Duren, rechterkolom de voorgestelde poster. De bestaande poster `hero-poster-1434` blijft staan; die is wel de eigen hal. |
| F19 | **`c7181cd4….mov` is een montage van twee verschillende locaties. Niet geplaatst.** 20,2 s, 1024x576, 25 fps. Scenedetectie vindt veertien wissels; het gevraagde bereik **3,6 tot 8,9 s bevat er vier**, dus dat is geen doorlopend overzichtsshot maar vier shots. Erger: dat hele bereik speelt in de La Vida Padel-hal, niet bij Van Duren. Het enige stuk dat aantoonbaar Van Duren is loopt van **10,6 tot 13,5 s** en heeft zelf ook een wissel op 12,24 s. Langste doorlopende shot in het hele bestand is 2,0 s. Er zit dus geen bruikbare hero-loop in dit bestand. Vraag Bennet om de originele `Van_Duren_Versie_1a.mp4` (254 MB, staat nog niet in Drive) of om ruwe opnames zonder montage. |
